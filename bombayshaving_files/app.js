...
var cdnUrl = 'https://sdk.truepush.com/';
var browserData = {"ua":"Mozilla/5.0 (Macintosh; Intel Mac OS X 10_12_6) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/77.0.3865.90 Safari/537.36","browser":{"name":"Chrome","version":"77.0.3865.90","major":"77"},"engine":{"name":"Blink"},"os":{"name":"Mac OS","version":"10.12.6"},"device":{},"cpu":{}};
        ...
        <div class="optin-customization default-optin-tp">
            <div class="default-box">
                <a href="https://www.truepush.com?medium=tp&source=sfcgvd79i" target="_blank">
                    <span> Webpush by  <img src="`+cdnUrl+`email_icons/logo_sm.png" alt=""> <span style="text-decoration: underline"> Truepush </span> </span>
                </a>
            </div>
        </div>
    `,
...
this.HideOptin = function(type) {
  ...
  if(!platformDetails.websiteSSL) iFrameParentReference.postMessage({type: "hideOptin"}, "*");
    ...
    var serverTime = 1571120042483;
    var timeDiff = 1571120042483 - Date.now();
    var loadingObject = {
